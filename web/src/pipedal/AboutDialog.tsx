                ...
                <div style={{ display: "flex", flexDirection: "column", flexWrap: "nowrap", width: "100%", height: "100%", overflow: "hidden" }}>
                    ...
                    >
                        <div id="debug_info" style={{
                            ...
                            <div style={{ display: "flex", flexFlow: "row nowrap" }}>
                                <Typography noWrap display="block" variant="h6" color="textPrimary" style={{ flexGrow: 1, flexShrink: 1 }}>
                                    <span style={{
                                        ...
                                        backgroundClip: 'text'
                                    }}>MAP2 Audio</span> <span style={{ fontSize: "0.7em" }}>
                                        {serverVersion
                            ...
                            <Typography noWrap display="block" variant="body2" style={{ marginBottom: 4 }}  >
                                Powered by PiPedal - Copyright &#169; 2022-2025 Robin Davies.
                            </Typography>
                            <Typography noWrap display="block" variant="body2" style={{ marginBottom: 12 }}  >
                                MAP2 Extensions - Copyright &#169; 2025 MAP2 Audio.
                            </Typography>
                            ...
                            <div style={{ marginBottom: 16 }}>
                                <Typography display="block" variant="body2" style={{ marginBottom: 0, marginLeft: 24 }}  >
                                    <strong>NAM Models:</strong> ~/.local/share/map2/nam
                                </Typography>
                                <Typography display="block" variant="body2" style={{ marginBottom: 0, marginLeft: 24 }}  >
                                    <strong>Cabinet IRs:</strong> ~/.local/share/map2/ir/cabinets
                                </Typography>
                                <Typography display="block" variant="body2" style={{ marginBottom: 0, marginLeft: 24 }}  >
                                    <strong>Reverb IRs:</strong> ~/.local/share/map2/ir/reverbs
                                </Typography>
                                <Typography display="block" variant="caption" style={{ marginTop: 8, marginLeft: 24, color: '#888' }}  >
                                    Place your .nam and .wav files in these directories for auto-discovery.
                                </Typography>
                            </div>
