...
import type { PatchCord } from './mpx1SignalPathRouting'

interface MPX1SignalPathPatchCordsProps {
  cords: PatchCord[]
...
export function MPX1SignalPathPatchCords({ cords, nodeRefs, canvasRef }: MPX1SignalPathPatchCordsProps) {
...
export { MPX1SignalPathPatchCords as MPX1FlowPatchCords }
export default MPX1SignalPathPatchCords
