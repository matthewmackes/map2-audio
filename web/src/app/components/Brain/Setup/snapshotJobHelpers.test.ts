...
function asset(overrides: Partial<BrainLibraryAssetModel>): BrainLibraryAssetModel {
  return {
    asset_id: 'a1',
    name: 'Test Asset',
...
function library(overrides: Partial<BrainLibraryStateModel>): BrainLibraryStateModel {
  return {
    collections: [],
    featured_assets: [],
