...
import { CheckmarkFilled as Bell, Close as X, WarningAlt as Warning, WarningAltFilled as WarningCircle } from '@carbon/icons-react'
            ...
            >
              ...
              <Box sx={{ mt: 0.5 }}>
                {alert.severity === 'critical' ? (
                  <Warning size={20} style={{ color: iconColor }} />
                ) : (
                  <WarningCircle size={20} style={{ color: iconColor }} />
                )}
              </Box>
