/**
 * useFlowUndoRedo — lightweight client-side undo/redo stack for the IntelFX Flow Canvas.
 *
 * Only tracks changes initiated from UI callbacks (bypass toggles, sidebar param changes).
 * WebSocket `intelfx:param_rx` events from the hardware are NOT pushed onto this stack.
 */
