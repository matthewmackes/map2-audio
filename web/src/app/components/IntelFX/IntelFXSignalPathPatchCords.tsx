...
import type { IntelFXPatchCord } from './intelfxSignalPathRouting'
...
interface IntelFXSignalPathPatchCordsProps {
  cords: IntelFXPatchCord[]
  nodeRefs: Record<string, React.RefObject<HTMLElement | null>>
  canvasRef: React.RefObject<HTMLDivElement | null>
}

export function IntelFXSignalPathPatchCords({ cords, nodeRefs, canvasRef }: IntelFXSignalPathPatchCordsProps) {
...
export { IntelFXSignalPathPatchCords as IntelFXFlowPatchCords }
export default IntelFXSignalPathPatchCords
