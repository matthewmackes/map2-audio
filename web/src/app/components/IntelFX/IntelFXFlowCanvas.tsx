...
import { IntelFXFlowPatchCords } from './IntelFXFlowPatchCords'
      ...
      <div className="intelfx-flow__workspace">
        ...
        >
          ...
          >
            ...
            <IntelFXFlowPatchCords cords={patchCords} nodeRefs={nodeRefs} canvasRef={canvasInnerRef} />
          </div>
        </div>
...
export default IntelFXFlowCanvas
