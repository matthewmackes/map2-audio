/**
 * FontAudio Icon: Automation 4P
 * Represents multi-effect processing - complex multi-stage effects
...
export const MultiEffectIcon = React.forwardRef<
  SVGSVGElement,
...
MultiEffectIcon.displayName = 'MultiEffectIcon'
