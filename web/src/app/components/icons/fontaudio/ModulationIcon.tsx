/**
 * FontAudio Icon: Phase
 * Represents modulation processing - phase modulation effects
...
export const ModulationIcon = React.forwardRef<
  SVGSVGElement,
...
ModulationIcon.displayName = 'ModulationIcon'
