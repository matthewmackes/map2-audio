/**
 * FontAudio Icon: Foldback
 * Represents reverb processing - feedback and reflections
...
export const ReverbIcon = React.forwardRef<
  SVGSVGElement,
