...
export const POSTER_MANIFEST: PosterManifestEntry[] = [
  ...
  { route: '/welcome', label: 'Guide', slug: 'guide', temperature: 'cool' },
  { route: '/about', label: 'About', slug: 'about', temperature: 'neutral' },
  ...
  { route: '/grid', label: 'Grid', slug: 'grid', temperature: 'cool' },
  { route: '/grid-3d', label: '3D Grid', slug: 'grid-3d', temperature: 'cool' },
