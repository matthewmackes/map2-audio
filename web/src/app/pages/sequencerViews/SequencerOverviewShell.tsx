...
import { BoTag, computeWarnCount, SEQUENCER_VIEW_IDS, type SequencerOverviewSharedProps, type SequencerViewId } from './sequencerViewShared'
...
const TAB_META: Record<SequencerViewId, { label: string; sub: string; Icon: typeof DataStructured }> = {
 ...
 * SequencerPage. This shell simply reads `?section=` and falls back to
