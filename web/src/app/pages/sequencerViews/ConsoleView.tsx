...
import { BoKV, BoTag, formatMs, formatPercent, slotColor, type SequencerOverviewSharedProps } from './sequencerViewShared'
import { useSequencerChannelMeters, type SequencerChannelMeter } from '../../hooks/useSequencerChannelMeters'
import { useSequencerMonitorCandidates } from '../../components/Devices/hooks/useDeviceProfiles'
...
const IDLE_METER: SequencerChannelMeter = {
  slotId: -1,
...
export function ConsoleView({
  ...
  const monitorQuery = useSequencerMonitorCandidates()
  const benchMonitor = (() => {
