...
import { useBrainChannelMeters } from './useBrainChannelMeters'
...
function Probe(): JSX.Element {
  const state = useBrainChannelMeters({ useWebSocket: false, pollingIntervalMs: 50 })
  return (
    <ul>
...
test('polling fallback hydrates per-slot meters from /api/engine/brain/metering', async () => {
  mockFetchOnce({
    payload: {
      running: true,
      slots: [
