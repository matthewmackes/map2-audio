...
const baseNavigationCatalog: ShellNavigationItem[] = [
  ...
  {
    to: '/multitrack-recorder',
    label: 'MultiTrack Recorder',
    shortLabel: 'Recorder',
    icon: RecordingFilledAlt,
    description: 'Open the MultiTrack Recorder — the DAW workspace for capture, arrangement, editing, mixdown, and session export.',
...
export const PINNED_ROUTE_ALIASES: Record<string, string> = {
  ...
  '/grid-3d': '/juce-grid',
  '/nodes': '/node-ops',
  '/multi-system': '/node-ops',
  '/overview': '/node-ops',
  '/platform': '/node-ops',
  '/platforms/overview': '/node-ops',
  '/workspace': '/node-ops',
  '/workspace/platforms/overview': '/node-ops/overview',
  '/theme': '/node-ops/theme',
  '/midpoint': '/node-ops/midpoint',
  ...
  '/workspace/platforms/midpoint': '/node-ops/midpoint',
  '/platforms/midpoint': '/node-ops/midpoint',
  '/engine': '/node-ops/audio-engine',
  '/platforms/audio-engine': '/node-ops/audio-engine',
  '/workspace/platforms/audio-engine': '/node-ops/audio-engine',
  '/avb-routing': '/avb/routing',
  '/midi-cluster': '/midi-hub/connections',
  '/cluster-dashboard': '/node-ops/cluster-dashboard',
  '/platforms/cluster-dashboard': '/node-ops/cluster-dashboard',
  '/workspace/platforms/cluster-dashboard': '/node-ops/cluster-dashboard',
  '/platforms/network-discovery': '/node-ops/network-discovery',
  '/workspace/platforms/network-discovery': '/node-ops/network-discovery',
  '/platforms/management': '/node-ops/management',
  '/workspace/platforms/management': '/node-ops/management',
  '/platforms/adoption': '/node-ops/adoption',
  ...
  '/midi': '/midi-hub',
  'platform:layer:overview': '/node-ops',
  'platform:layer:single-node': '/node-ops/management',
  'platform:layer:management': '/node-ops/management',
  'platform:layer:avb-routing': '/avb/routing',
  'platform:layer:midi-cluster': '/midi-hub/connections',
  'platform:layer:network-discovery': '/node-ops/network-discovery',
  'platform:layer:cluster-dashboard': '/node-ops/cluster-dashboard',
  'platform:panel:host-machine': HOST_MACHINE_ROUTE,
  'platform:panel:audio-engine': '/node-ops/audio-engine',
