...
const baseNavigationCatalog: ShellNavigationItem[] = [
  ...
  {
    to: '/platform',
    label: 'Platforms and Labs',
    shortLabel: 'Platforms + Labs',
    icon: MapClusterFabricIcon,
    description: 'Open the unified Platforms and Labs window to move through overview, node, AVB, MIDI cluster, API, fleet, and relocated lab workflows from one shell surface.',
    color: 'var(--cds-support-warning)',
    homeSection: 'System',
    includeInAdvancedMenu: false,
    pinnable: false,
