...
const baseNavigationCatalog: ShellNavigationItem[] = [
  ...
  },
  {
    ...
    shortLabel: 'APIs',
    icon: Terminal,
    description: 'Explore, test, and monitor every API endpoint across MAP2 with a developer workbench for REST, WebSocket, cluster peers, and device protocols.',
    color: 'var(--cds-link-primary)',
    homeSection: 'System',
    includeInAdvancedMenu: true,
    pinnable: true,
  ...
  },
  {
    ...
    label: 'MIDI Hub-2',
    icon: MusicNotes,
    description: 'Open the HxMIDI-style advanced MIDI control surface with Preset, Filter, Mapper, Router, Firmware, and Settings workflows in MAP2 theme.',
    color: 'var(--cds-support-warning)',
    homeSection: 'MIDI',
    includeInAdvancedMenu: true,
    pinnable: true,
