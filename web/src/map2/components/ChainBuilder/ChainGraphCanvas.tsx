// ============================================================================
// MAP2 Audio Platform - Chain Graph Canvas Component
// Main React Flow container for signal-chain graph visualization
// ============================================================================
...
function ChainGraphCanvasInner({
  ...
  const { nodes, edges, setNodes, setEdges, onNodesChange: handleNodesChange, onEdgesChange, onConnect } =
    useChainGraph(initialNodes, initialEdges);
...
function ChainGraphCanvas(props: ChainGraphCanvasProps) {
  return (
    <ReactFlowProvider>
...
export { ChainGraphCanvas as ChainFlowCanvas };
export type ChainFlowCanvasProps = ChainGraphCanvasProps;
