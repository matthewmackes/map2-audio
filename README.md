...
<!-- PROJECT-STATS:START -->
**1034** Python | **1124** TypeScript | **136** C++/H | **140** Docs | **1649** total commits | **3** stars | **0** forks | **0** open issues
<!-- PROJECT-STATS:END -->
...
|:---------|:------------|
| [PROJECT WORKLIST](https://github.com/matthewmackes/map2-audio/blob/master/docs/PROJECT_WORKLIST.md) | 2026-04-09 |
