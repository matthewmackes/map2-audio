...
<!-- PROJECT-STATS:START -->
**913** Python | **1010** TypeScript | **131** C++/H | **129** Docs | **1116** total commits | **3** stars | **0** forks | **0** open issues
<!-- PROJECT-STATS:END -->
...
|:---------|:------------|
| [PROJECT WORKLIST](https://github.com/matthewmackes/map2-audio/blob/master/docs/PROJECT_WORKLIST.md) | 2026-03-31 |
