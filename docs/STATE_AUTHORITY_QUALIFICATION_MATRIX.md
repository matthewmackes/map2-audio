...
| --- | --- | --- |
| 1 | Graph foundation, validation, asset registry | `python3 -m pytest -q tests/test_state_authority_graph.py tests/test_snapshot_service.py -k 'persists_and_reads_state_authority_document or rejects_invalid_state_authority_document_write or restores_asset_paths_from_state_authority_registry'` |
