...
Sub-tasks:
- `T2510-0` — **NEW prerequisite, filed 2026-06-02 (operator decision in ship loop). [ ] Todo — build now, no defer (pre-release, no current users → no migration; per the standing "no defer / next release" directive).**
