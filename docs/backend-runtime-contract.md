...
| `MAP2_AUDIO_PLUGIN_LEVELS_CACHE_TTL_SECONDS` | `app/routes/audio/monitoring.py:18` | `'0.25'` | 1 |
| `MAP2_AUDIO_PLUGIN_LEVELS_TIMEOUT_SECONDS` | `app/routes/audio/monitoring.py:22` | `'0.06'` | 1 |
| `MAP2_AUDIO_STATUS_CACHE_TTL_SECONDS` | `app/routes/audio/monitoring.py:30` | `'0.20'` | 1 |
