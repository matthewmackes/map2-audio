# MAP2 FAQ: Simple Consumer Version

**Date:** April 10, 2026

## What This Version Is

This is a simpler version of the MAP2 FAQ written for a general audience. It avoids most technical language and explains the platform in everyday terms.

This document keeps the same overall meaning as the more detailed FAQ, but it is written for readers who want to understand:

- what MAP2 is
- why someone would want it
- how different kinds of musicians and audio workers could use it

It also keeps the same important limit:

- MAP2 is presented in this repository as an **open-source educational and research project**
- it should not be described as a fully finished mass-market commercial product
