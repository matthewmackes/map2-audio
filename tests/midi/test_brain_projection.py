"""T2482-P2.4: Brain consumer projection tests.
...
from app.services.midi.projections.brain import (
...
def test_payload_for_snapshot_consumer_uses_pc_source_and_snapshot_target():
    ...
    assert payload.metadata["legacy_consumer_name"] == "Brain — KBD (set up 2026-04-30)"
...
def test_round_trip_via_synthetic_binding_read():
    ...
    assert legacy["consumer_name"] == "Brain — KBD"
