"""T2461-A4 — Sequencer action registry tests."""
...
from app.services.sequencer.sequencer_action_registry import (
...
def test_find_action_known_id_returns_descriptor():
    ...
    assert isinstance(descriptor, SequencerActionDescriptor)
...
def test_route_returns_actions_payload(client):
    r = client.get("/api/engine/sequencer/actions")
