"""
Pydantic response models shared across legacy routes.

This module preserves the original `app.models` contract while the newer node
schemas live under `app.models.node`.
"""
