"""Brain consumer projection over the MidiBinding canonical authority.
...
def device_binding_to_create_payload(
    *,
    ...
    Brain Setup); for unknown consumer types we use empty descriptors
    ...
    # Brain device bindings are not snapshot-scoped — they apply
