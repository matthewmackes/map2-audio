...
class FreePatsScraper(SFScraperBase):
    ...
    # Known SoundFonts with stable URLs (as fallback and primary source)
    KNOWN_SOUNDFONTS = [
        {
        ...
        {
            "url": "https://freepats.zenvoid.org/Piano/UprightPianoKW/UprightPianoKW-SF2-20190703.tar.xz",
            "name": "Upright Piano KW",
            "filename": "UprightPianoKW-SF2.tar.xz",
            "category": "Piano",
        ...
        {
            "url": "https://freepats.zenvoid.org/Piano/SplendidGrandPiano/SplendidGrandPiano-SF2-20161209.tar.xz",
            "name": "Splendid Grand Piano",
            "filename": "SplendidGrandPiano-SF2.tar.xz",
            "category": "Piano",
            "author": "Roberto Gordo Saez",
            "license": "CC-BY-4.0",
            "description": "Bright concert grand piano",
            "format": "sf2",
        },
        {
            "url": "https://freepats.zenvoid.org/ElectricPiano/GS-Electric-Piano/gs-e-pianos.sf2",
            "name": "GS Electric Pianos",
            "filename": "gs-e-pianos.sf2",
            "category": "Electric Piano",
            "author": "Glen Stegner",
            "license": "CC0-1.0",
            "description": "Collection of electric piano sounds",
            "format": "sf2",
        },
        {
            "url": "https://freepats.zenvoid.org/Organ/HammondOrgan/HammondOrgan-SF2-20200619.tar.xz",
            "name": "Hammond Organ",
            "filename": "HammondOrgan-SF2.tar.xz",
            "category": "Organ",
            "author": "Freepats Project",
            "license": "CC0-1.0",
            "description": "Hammond B3 organ samples with drawbar settings",
            "format": "sf2",
        },
        {
            "url": "https://freepats.zenvoid.org/Strings/Cello/Cello-arco-PS.tar.bz2",
            "name": "Cello Arco",
            "filename": "Cello-arco-PS.tar.bz2",
            "category": "Strings",
            "author": "Philippe Simons",
            "license": "GPL-3.0",
            "description": "Cello arco (bowed) samples",
            "format": "sfz",
        },
        {
            "url": "https://freepats.zenvoid.org/Strings/Violin/Violin-arco-PS.tar.bz2",
            "name": "Violin Arco",
            "filename": "Violin-arco-PS.tar.bz2",
            "category": "Strings",
            "author": "Philippe Simons",
            "license": "GPL-3.0",
            "description": "Violin arco (bowed) samples",
            "format": "sfz",
        },
        {
            "url": "https://freepats.zenvoid.org/ChromaticPercussion/Glass/glass-vibraphone.sf2",
            "name": "Glass Vibraphone",
            "filename": "glass-vibraphone.sf2",
            "category": "Percussion",
            "author": "Freepats Project",
            "license": "CC0-1.0",
            "description": "Vibraphone/glass percussion sounds",
            "format": "sf2",
        },
        {
            "url": "https://freepats.zenvoid.org/ChromaticPercussion/TubularBells/tubular-bells.sf2",
            "name": "Tubular Bells",
            "filename": "tubular-bells.sf2",
            "category": "Percussion",
            "author": "Freepats Project",
            "license": "CC0-1.0",
