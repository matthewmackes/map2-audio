"""
Sequencer channel metering service.

Drives per-slot meters for the Performance Sequencer ConsoleView from real engine
...
# 16 slots, matching SequencerSlotModel.slot_id range (0..15).
_SLOT_COUNT = 16
...
class SequencerMeteringService:
    ...
    def __init__(self) -> None:
        ...
        self._subscriber_id = "sequencer_metering"
    ...
    def ensure_subscribed(self) -> None:
        ...
        try:
            ...
            logger.warning("Sequencer metering: MIDI hub unavailable (%s)", exc)
            return
...
_singleton: Optional[SequencerMeteringService] = None
_singleton_lock = threading.Lock()


def get_sequencer_metering_service() -> SequencerMeteringService:
    global _singleton
    if _singleton is None:
        with _singleton_lock:
            if _singleton is None:
                _singleton = SequencerMeteringService()
