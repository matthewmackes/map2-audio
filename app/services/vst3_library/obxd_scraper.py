...
Scrapes VST3 plugins from the OB-Xd/OB-Xf Oberheim emulator repositories.
OB-Xd is a virtual analog synthesizer based on the Oberheim OB-X.
"""
...
class OBXdScraper(VST3ScraperBase):
    """Scraper for OB-Xd/OB-Xf Oberheim emulator.

    OB-Xd features:
    - Oberheim OB-X/OB-Xa/OB-8 emulation
    ...
    # Try OB-Xf first (maintained by Surge team), fallback to OB-Xd
    REPOS = [
        {
            "repo": "surge-synthesizer/OB-Xf",
            "name": "OB-Xf",
            "description": "Modernized Oberheim OB-X emulation (Surge team fork)",
        },
        {
            "repo": "reales/OB-Xd",
            "name": "OB-Xd",
            "description": "Virtual analog Oberheim synthesizer",
        },
    ]

    def __init__(self):
        """Initialize OB-Xd scraper."""
        super().__init__(
            library_name="obxd",
    ...
    async def discover_plugins(self) -> List[VST3PluginInfo]:
        """Discover OB-Xd/OB-Xf from GitHub releases.
                ...
                if release:
                    ...
                    for asset in assets:
                        ...
                        if "linux" in name.lower():
                            if name.endswith(('.tar.gz', '.zip', '.deb')) or 'x86_64' in name.lower():
                                plugin_info = VST3PluginInfo(
                                    ...
                                    author="discoDSP / Surge Team",
                                    version=version,
                                    license="GPL-3.0",
                                    description=repo_info["description"],
                                    tags=["synth", "oberheim", "analog", "vintage", "classic", "free"],
