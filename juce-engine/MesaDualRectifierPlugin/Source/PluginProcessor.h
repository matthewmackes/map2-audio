...
class MesaDualRectifierAudioProcessor : public juce::AudioProcessor,
                                        public juce::AudioProcessorValueTreeState::Listener
{
public:
    MesaDualRectifierAudioProcessor();
    ~MesaDualRectifierAudioProcessor() override;
    ...
    static constexpr const char* PARAM_RECTIFIER_MODE = "rectifierMode";
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(MesaDualRectifierAudioProcessor)
};
