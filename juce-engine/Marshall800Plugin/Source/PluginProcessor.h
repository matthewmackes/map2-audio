...
class Marshall800AudioProcessor : public juce::AudioProcessor,
                                  public juce::AudioProcessorValueTreeState::Listener
{
public:
    Marshall800AudioProcessor();
    ~Marshall800AudioProcessor() override;
    ...
    static constexpr const char* PARAM_HIGH_INPUT = "highInput";
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(Marshall800AudioProcessor)
};
